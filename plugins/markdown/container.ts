...
export const containerPlugin = (md: MarkdownIt) => {
  md.use(...createContainer('tip', '注', md))
    .use(...createContainer('info', '注', md))
    .use(...createContainer('warning', '警示', md))
    .use(...createContainer('danger', '警示', md))
    .use(...createContainer('details', '说明', md))
